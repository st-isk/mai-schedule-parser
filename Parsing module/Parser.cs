...
namespace Parsing_module
{
    public static class Parser
    {
        ...
        private static void Get_groups() //Метод, формирующий файл со списком всех групп; используется в методе Get_info()
        {
        ...
        /// <summary>
        /// Метод для сборки и упаковки информации о расписании с сайта mai.ru в предварительно созданную базу данных
        /// </summary>
        /// <param name="col">Коллекция на основе POCO-класса SchedulePos созданной NoSQL БД, в которую необходимо поместить данные о расписании</param>
        /// <param name="get_groups">Перепарсить данные о списке групп?</param>
